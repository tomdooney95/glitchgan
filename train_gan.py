...
data = np.load('data/glitch_GAN_samples_scaled_balanced.npy')
data_deriv = np.load('data/glitch_GAN_deriv_samples_balanced.npy')
class_array = np.load('data/glitch_GAN_labels_balanced.npy')
...
Examples_generator(gan,switch_sim_uni = True,output_path = output_path)
